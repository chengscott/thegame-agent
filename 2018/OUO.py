    ...
    def action(self, hero, heroes, polygons, bullets):
        ...
        if heroes:
            ...
            if hero.level>=9 :
                ...
                d = min(dis)
                p = dis.index(d)
                if heroes[p].health>hero.abilities.max_health.value or (heroes[p].level-hero.level)>=10:
                ...
                if polygons:
                    ...
                    if hero.abilities.body_damage.level==8 and currentper>0.3:
                        ...
                        self.accelerate_towards(polygons[p].position[0]-150,polygons[p].position[1]-150)
                else:
                    ...
                    if hero.abilities[Ability.MaxHealth].level == 8:
                        ...
                        if hero.abilities[Ability.MovementSpeed].level == 8:
                            ...
                            if hero.abilities[Ability.Reload].level == 8:
                                ...
                                if hero.abilities[Ability.BulletSpeed].level == 8:
                                    self.level_up(Ability.BulletDamage)
                                    if hero.abilities[Ability.BulletDamage].level == 8:
