        ...
        if bullets:
            if abs(
                ((bullets[0].position[0] - hero.position[0])**2 +
                 (bullets[0].position[1] - hero.position[1])**2)**0.5) < 100:
                if abs(bullets[0].position[1] - hero.position[1]) < 100 or abs(
                        bullets[0].position[0] - hero.position[0]) < 40:
                    self.accelerate(6.28)
                elif abs(bullets[0].position[1] -
                         hero.position[1]) < 40 or abs(bullets[0].position[0] -
                                                       hero.position[0]) < 100:
